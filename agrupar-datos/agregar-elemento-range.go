...
func main() {
	...
	*/
	...
	// agregar un nuevo indice o prpiedad al mapa
	...
	for key, value := range m1 {
		...
		if ok { // dentro del if se asigna la respuesta y se ejecuta la condicion
			fmt.Println(" La llave existe y su valor es", key, value)
		} else {
			fmt.Println("La llave no existe", key, value)
		}
	}
